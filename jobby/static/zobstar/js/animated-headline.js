jQuery(document).ready(function(a) {
    function l() {
        m(a(".cd-headline.letters").find("b")),
        n(a(".cd-headline"))
    }
    function m(b) {
        b.each(function() {
    ...
    function o(a) {
        ...
        if (a.parents(".cd-headline").hasClass("type")) {
            ...
            k.addClass("selected").removeClass("waiting"),
            setTimeout(function() {
            ...
            var l = a.children("i").length >= i.children("i").length ? !0 : !1;
            q(a.find("i").eq(0), a, l, e),
            r(i.find("i").eq(0), i, l, e)
        } else
    ...
    function p(a, b) {
        a.parents(".cd-headline").hasClass("type") ? (r(a.find("i").eq(0), a, !1, b),
    ...
    function q(c, d, e, f) {
        if (c.removeClass("in").addClass("out"),
        c.is(":last-child") ? e && setTimeout(function() {
            o(s(d))
        }, b) : setTimeout(function() {
            q(c.next(), d, e, f)
        }, f),
        c.is(":last-child") && a("html").hasClass("no-csstransitions")) {
            var g = s(d);
            u(d, g)
        }
    }
    function r(a, c, d, e) {
        ...
        a.is(":last-child") ? (c.parents(".cd-headline").hasClass("type") && setTimeout(function() {
